...
class Dots_and_Boxes():
    ...
    def display_gameover(self):
        ...
        score_text = f'{self.player1_name}: {player1_score}\n'
        score_text += f'{self.player2_name}: {player2_score}\n'
    ...
    def display_turn_text(self):
        text = f'Next turn: {self.player1_name if self.player1_turn else self.player2_name}'
